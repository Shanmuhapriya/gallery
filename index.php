...
<html lang="en">
  ...
  <body>
      ...
      <div class="container" id="Home">
          ...
          <p>In other words, Photography is also a creative process. It’s a way to express your idea through images and convey emotions to the viewer.</p>       
          <h3>Why Photography</h3>
          <ul>
              <li>Photography is Important to Collect Meaningful Moments in Your Life</li>
              <li>Photography is Important as a Hobby Because You Keep Learning</li>
              <li>You’ll Meet Likeminded People</li>
              <li>Photography can not only tell us about the past, but it can also change the future.</li>
              <li>Photography is Important for Your Business</li>
          </ul>
          ...
          <h3>Few Famous Photographers</h3>
          <ul>
              ...
              <li>Irving Penn</li>
              <li>Cindy Sherman</li>
              <li>Mary Ellen Mark</li>
              <li>Robert Frank</li>
              <li>Elliott Erwitt</li>
              <li>Mario Testino</li>
          </ul>
          </div>
          </div>
          ...
          <div id="Register" align="center">
            <div class="h-tag">
            <h2 style="text-align: center;">Help Us Know You Better!!</h2>
            </div>
            <!-- create account div -->
            <form action="registration.php" method="POST" align="center" style="border: 0px; margin: 0px 50px">
            <div class="login">
